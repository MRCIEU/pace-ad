...
plots_outfile <- "results/meta-summary/man-qqs-eur.tiff"
summary_outfile <- "results/meta-summary/comparison-summary.RData"
qq_outfile <- "results/meta-summary/meta-qqs.png"

meta_files <- "results/metal-res/m1c-euro.txt results/metal-res/m2c-euro.txt results/metal-res/m3c-euro.txt"
meta_files <- unlist(str_split(meta_files, " "))

m1_man_outfile <- "results/meta-summary/meta-m1-manhattan_eur.png"
m2_man_outfile <- "results/meta-summary/meta-m2-manhattan_eur.png"
m3_man_outfile <- "results/meta-summary/meta-m3-manhattan_eur.png"

n<-gsub("results/metal-res/","",meta_files)
n<-gsub("m1c-euro","childhood AD",n)
n<-gsub("m2c-euro","early-onset AD",n)
n<-gsub("m3c-euro","persistent AD",n)
n<-gsub(".txt","",n)
nlab<-n
